--Chat group Impressions(joined)
select distinct c.value.string_value as chat_group,count(distinct device.advertising_id) as chat_group_Impressions_joined
    ...
    and b.key = 'group_status' and b.value.int_value = 1 and c.key = 'group_name' 
