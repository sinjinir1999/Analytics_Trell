...
select distinct c.value.string_value as chat_group,count(distinct device.advertising_id) as message
    ...
    and b.key = 'current_page_name' and b.value.string_value = 'group_chat' and c.key = 'group_name' and d.key = 'trell_message_type' and d.value.string_value = 'image'
